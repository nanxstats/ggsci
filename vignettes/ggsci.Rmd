...
|                 | `scale_fill_simpsons()`      |                                |                      |
+-----------------+------------------------------+--------------------------------+----------------------+
| Squid Game      | `scale_color_squidgame()`    | `"stair_room"`                 | `pal_squidgame()`   |
|                 | `scale_fill_squidgame()`     |                                |                      |
+-----------------+------------------------------+--------------------------------+----------------------+
...
This palette is inspired by the colors used in the Netflix show
<emph>Squid Game</emph>:

```{r, fig.width = 10.67, fig.height = 4, out.width = 800, out.height = 300, dpi = 150}
p1_squidgame <- p1 + scale_color_squidgame()
p2_squidgame <- p2 + scale_fill_squidgame()
grid.arrange(p1_squidgame, p2_squidgame, ncol = 2)
```
