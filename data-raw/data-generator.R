...
ggsci_db$'igv'$'default' =
  c('chr1'  = '#5050FF', 'chr2'  = '#CE3D32', 'chr3'  = '#749B58',
...
# Color palette inspired by IGV
ggsci_db$'igv'$'alternating' =
  c('Indigo' = '#5773CC', 'SelectiveYellow' = '#FFB900')

# Color palette inspired by LocusZoom
ggsci_db$'locuszoom'$'default' =
  c('0.8to1.0' = '#D43F3A', '0.6to0.8' = '#EEA236',
...
ggsci_db$'startrek'$'uniform' =
  c('Engineering' = '#CC0C00', 'Sciences' = '#5C88DA',
