...
# Color palette inspired by Squid Game
ggsci_db$"squidgame"$"stair_room" <- c(
  "Bunting" = "#16274B", "Disco" = "#A71967",
  "Christi" = "#8C9E0E", "JellyBean" = "#298EA6",
  "Tapestry" = "#B86AA5", "Feijoa" = "#96E282",
  "Castro" = "#520026", "Clover" = "#3C4310"
)
...
# test_barplot("squidgame", "stair_room")
