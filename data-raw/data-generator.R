...
# barplot(rep(1, 10), col = ggsci_db$"cosmic"$"hallmarks_dark")
# barplot(rep(1, 10), col = ggsci_db$"cosmic"$"hallmarks_light")
# barplot(rep(1, 6), col = ggsci_db$"cosmic"$"signature_substitutions")
