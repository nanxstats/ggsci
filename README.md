...
[Browse the vignette](https://ggsci.net/articles/ggsci.html) (or open with `vignette("ggsci")` in R) for a quick-start guide.
...
To contribute to this project, please take a look at the [Contributing Guidelines](https://github.com/road2stat/ggsci/blob/master/CONTRIBUTING.md) first. Please note that this project is released with a [Contributor Code of Conduct](https://github.com/road2stat/ggsci/blob/master/CONDUCT.md). By participating in this project you agree to abide by its terms.
